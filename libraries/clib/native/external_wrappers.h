...
KAFFE_NATIVE(Java_java_lang_reflect_Method_invoke)
...
KAFFE_NATIVE(Java_kaffe_lang_UNIXProcess_destroy)
KAFFE_NATIVE(Java_kaffe_lang_UNIXProcess_run)
KAFFE_NATIVE(Java_kaffe_io_CharToByteDefault_convert)
KAFFE_NATIVE(Java_kaffe_io_ByteToCharDefault_convert)
KAFFE_NATIVE(java_util_zip_ZipFile_openZipFile0)
KAFFE_NATIVE(java_util_zip_ZipFile_closeZipFile0)
KAFFE_NATIVE(java_util_zip_ZipFile_getZipEntry0)
KAFFE_NATIVE(java_util_zip_ZipFile_getZipData0)
KAFFE_NATIVE(java_util_zip_ZipFile_getZipEntries0)
KAFFE_NATIVE(java_text_DateFormat_format0)
#if defined(DEBUG)
/*
