    ...
    implements java.rmi.dgc.DGC
{
    ...
    static {
        try {
            ...
            useNewInvoke = true;
            $method_clean_0 = kaffe.rmi.dgc.DGCImpl.class.getMethod("clean", new java.lang.Class[] {java.rmi.server.ObjID[].class, long.class, java.rmi.dgc.VMID.class, boolean.class});
            $method_dirty_1 = kaffe.rmi.dgc.DGCImpl.class.getMethod("dirty", new java.lang.Class[] {java.rmi.server.ObjID[].class, long.class, java.rmi.dgc.Lease.class});
