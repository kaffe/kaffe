...
final public long get()
  {
    long a = MappedByteFileBuffer.nio_read_Long_file_channel(ch, position(), limit(), map_address);
    position(position() + 8);
    return a;
  }
final public LongBuffer put(long b)
  {
    MappedByteFileBuffer.nio_write_Long_file_channel(ch, position(), limit(), b, map_address);
    position(position() + 8);
    return this;
  }
final public long get(int index)
  {
    long a = MappedByteFileBuffer.nio_read_Long_file_channel(ch, index, limit(), map_address);
    return a;
  }
final public LongBuffer put(int index, long b)
  {
    MappedByteFileBuffer.nio_write_Long_file_channel(ch, index, limit(), b, map_address);
    return this;
  }
