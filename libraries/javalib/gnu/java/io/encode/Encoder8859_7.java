/* Encoder8859_7.java -- Encoder for ISO-8859-7 Character set.
...
/**
 * This class encodes bytes in ISO-8859-7 format to Unicode. 8859_7
 * ibm-813_P100-1995 ibm-813 ISO_8859_7 iso_8859_7 ISO8859_7 iso8859_7
 * ISO-8859-7 iso-8859-7 greek greek8 ELOT_928 ECMA-118 csISOLatinGreek
 * iso-ir-126 ISO_8859-7:1987 cp813 813 windows-28597
 * 
 * @version 0.0
 ...
 */
public class Encoder8859_7 extends EncoderEightBitLookup
{

  /**
   * This is the lookup table for this encoding
   */
  private static final char[]	lookup_table_8859_7	=
    { 0x0000, 0x0001, 0x0002,
      ...
      0x009B, 0x009C, 0x009D, 0x009E, 0x009F, 0x00A0, 0x2018, 0x2019,
      0x00A3, 0x0000, 0x0000, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x0000,
      0x00AB, 0x00AC, 0x00AD, 0x0000, 0x2015, 0x00B0, 0x00B1, 0x00B2,
      0x00B3, 0x00B4, 0x0385, 0x0386, 0x0387, 0x0388, 0x0389, 0x038A,
      0x00BB, 0x038C, 0x00BD, 0x038E, 0x038F, 0x0390, 0x0391, 0x0392,
      0x0393, 0x0394, 0x0395, 0x0396, 0x0397, 0x0398, 0x0399, 0x039A,
      0x039B, 0x039C, 0x039D, 0x039E, 0x039F, 0x03A0, 0x03A1, 0x0000,
  ...
  public Encoder8859_7(OutputStream out)
  {
    super(out, "8859_7", lookup_table_8859_7);
  }
