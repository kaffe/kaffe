/* EncoderWindows1252.java -- Encoder for Windows-1252 Character set.
...
/**
 * This class encodes bytes in Windows-1252 format to Unicode.
 * ibm-5348_P100-1997 ibm-5348 windows-1252 Windows-1252 cp1252 CP1252 cp-1252
 * CP-1252 Windows1252 windows1252
 * 
 * @version 0.0
 * @author Quentin Anciaux (quentin.anciaux@advalvas.be)
 * @author based on gnu.java.io.decode.Encoder8859_1 by Aaron M. Renn
 *         (arenn@urbanophile.com)
 */
public class EncoderWindows1252 extends EncoderEightBitLookup
{

  /**
   * This is the lookup table for this encoding
   */
  private static final char[]	lookup_table_windows_1252	=
    { 0x0000, 0x0001,
      ...
      0x0160, 0x2039, 0x0152, 0x008D, 0x017D, 0x008F, 0x0090, 0x2018,
      0x2019, 0x201C, 0x201D, 0x2022, 0x2013, 0x2014, 0x02DC, 0x2122,
      0x0161, 0x203A, 0x0153, 0x009D, 0x017E, 0x0178, 0x00A0, 0x00A1,
  ...
  public EncoderWindows1252(OutputStream out)
  {
    super(out, "Windows-1252", lookup_table_windows_1252);
  }
  
} // class EncoderWindows1252
