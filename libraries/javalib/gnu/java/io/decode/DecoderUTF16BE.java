/* DecoderUTF16BE.java -- Decoder for the UTF-16 Big Endian character encoding.
 ...
 */
public class DecoderUTF16BE extends Decoder
{
  ...
  public DecoderUTF16BE(InputStream in)
  {
    super(in, "UTF-16BE");
  }
  ...
  /**
   * Transform the specified UTF16BE encoded buffer to Unicode characters
   */
  ...
  /**
   * Reads chars from a UTF16BE encoded byte stream
   */
