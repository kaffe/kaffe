/* DecoderUTF16LE.java -- Decoder for the UTF-16 Little Endian character set.
 ...
 * Little Endian (UTF-16LE) encoding scheme.
 * 
 * @version 0.0
 * @author Quentin Anciaux (quentin.anciaux@advalvas.be)
 */
public class DecoderUTF16LE extends Decoder
{
  ...
  public DecoderUTF16LE(InputStream in)
  {
    super(in, "UTF-16LE");
  }
  ...
  /**
   * Transform the specified UTF16LE encoded buffer to Unicode characters
   */
  ...
  /**
   * Reads chars from a UTF16LE encoded byte stream
   */
