		...
		AccessController.doPrivileged(
			...
			public Object run() {
			    put("MessageDigest.MD2",
				    "org.kaffe.security.provider.MD2");
			    put("MessageDigest.MD4",
				    "org.kaffe.security.provider.MD4");
			    put("MessageDigest.MD5",
				    "org.kaffe.security.provider.MD5");
			    put("MessageDigest.SHA-1",
				    "org.kaffe.security.provider.SHA");
			    put("Alg.Alias.MessageDigest.SHA1",
				    "SHA-1");
			    put("Alg.Alias.MessageDigest.SHA",
				    "SHA-1");
			    put("SecureRandom.SHA1PRNG",
				    "org.kaffe.security.provider.SHA1PRNG");
			    return null;
			}
		    });
	}
