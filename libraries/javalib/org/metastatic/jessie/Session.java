/* Session.java -- SSLv3 and TLSv1 session data.
 ...
 */
class Session implements SSLSession
{
  ...
  protected SecurityParameters inParams;

  protected SecurityParameters outParams;
  ...
  SecurityParameters getInputParameters()
  {
    return inParams;
  }

  void setInputParameters(SecurityParameters inParams)
  {
    this.inParams = inParams;
  }

  SecurityParameters getOutputParameters()
  {
    return outParams;
  }

  void setOutputParameters(SecurityParameters outParams)
  {
    this.outParams = outParams;
  }

  void setSessionId(ID sessionId)
  {
  ...
  void setLocalCertificates(Certificate[] localCerts)
  {
    this.localCerts = localCerts;
  }

  void setPeerCertificates(Certificate[] peerCerts)
  {
  ...
  void setSessionContext(SSLSessionContext context)
  {
