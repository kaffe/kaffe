...
public class Jessie extends Provider
{
  ...
  public Jessie()
  {
    super("Jessie", 0.0, "Implementing SSLv3, TLSv1, TLSv1.1");
    ...
    put("KeyManagerFactory.GnuX509",   org.metastatic.jessie.X509KeyManagerFactory.class.getName());
    put("TrustManagerFactory.GnuX509", org.metastatic.jessie.X509TrustManagerFactory.class.getName());
  }
}
