...
/* NCR MP-RAS fix */
#define mutex_lock	ltdl_mutex_lock_func
#define mutex_unlock	ltdl_mutex_unlock_func
#define mutex_seterror	ltdl_mutex_seterror_func
#define mutex_geterror	ltdl_mutex_geterror_func
#define last_error	ltdl_mutex_last_error
/* End of NCR MP-RAS fix */
